...
Gem::Specification.new do |s|
  ...
  ## as you like.
  s.summary     = "New Relic Redshift plugin"
  s.description = <<-EOF
This is the New Relic plugin for monitoring Redshift developed by Chirag K. Parmar.
  ...
  s.author  = ["Chirag K. Parmar"]
  s.email    = 'chiragkparmar@gmail.com'
...
to find out how to install and run the plugin agent.
  ...
  s.files = %w[
    ...
    lib/newrelic_redshift_plugin.rb
    lib/newrelic_redshift_plugin/agent.rb
    lib/newrelic_redshift_plugin/version.rb
    newrelic_redshift_plugin.gemspec
    newrelic_redshift_plugin.png
  ]
  # = MANIFEST =
